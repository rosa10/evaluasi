...
<div class="box">
       ...
       @foreach ($soal as $soalValue)
        ...
        @foreach ($soalValue->pilihan as $pilihan)
            <div class="radio-inline">
              ...
              <input type="radio" name="nilai[{{$soalValue->id}}]" value="{{$pilihan->value}}" class="form-check-input" required>
    ...
    @endforeach
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name='kritik' required></textarea>
      </div>
